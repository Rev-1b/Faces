...
from video_loaders import YouTubeVideoDownloader
...
def main(normal_video_dir, deepfake_video_dir, raw_photos_dir, photos_dir, permanent_csv_file):
    while True:
        ...
        try:
            ...
            face_extractor = HaarcascadesExtractor(video_path, video_name, raw_photos_dir, is_deepfake, frame_skip)
...
def main2(normal_video_dir, raw_photos_dir, photos_dir, permanent_csv_file, links_file):
